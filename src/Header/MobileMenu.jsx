...
const MobileMenu = () => {
  ...
  const [isBookNowOpen, setBookNowOpen] = useState(false); // Define state for Book Now section
  ...
  const toggleBookNow = () => setBookNowOpen(!isBookNowOpen); // Use the defined setter
