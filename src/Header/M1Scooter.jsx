...
import M1img from "../images/Product Image copy M1.jpg";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-4xl font-extrabold text-gray-900 mb-8">
            Explore the Future of Maxtron M1 Mobility
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div>
              <img
                ...
                style={{ width: "600px", height: "400px", objectFit: "cover" }} // Set the size here
              />
            </div>
